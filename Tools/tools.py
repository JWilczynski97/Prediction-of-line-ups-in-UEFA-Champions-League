...
class Database:
    """ Class to represent the SQLite database from 'file'. """

    def __init__(self, file, logger=None, by_column=True):
        """ Function to create connection to the database and cursor. \n
        :param path: str, local path to .db file with sqlite database
...
class Logger:
    ...
    The messages may be wrote to the standard output and saved to the files on the local disk in directory log_folder."""
