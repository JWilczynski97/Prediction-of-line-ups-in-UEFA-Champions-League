...
# The aim of this program was to determine best values parameters for the machine learning algorithms: Decision Tree, Random Forest, K-neighbors, SVR.
# GridSearchCV class from scikit-learn library was used (https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html).

# import libraries implementing machine mearning algorithms
from sklearn.tree import DecisionTreeRegressor
from sklearn.ensemble import RandomForestRegressor
from sklearn.svm import SVR
from sklearn.neighbors import KNeighborsRegressor

# GridSearch - class to find best values of parameters for the used ML algorithms
...
print("Best parameters for Decision Tree: ", gs_tree.best_params_)
# RESULTS -> best params for Decision Tree algorithm: criterion = 'mse', max_depth = 6
...
print("Best parameters for Random Forest: ", gs_forest.best_params_)
# RESULTS -> best params for Random Forest algorithm:: n_estimators = 137, bootstrap = True
...
# RESULTS -> best params for K Neighbors algorithm: n_neighbors = 5, p = 1, weights = 'distance'
...
print("Best parameters for SVR: ", best_svm)
# RESULTS -> best params for SVR algorithm: C = 0.01, epsilon = 0.1, gamma = scale
